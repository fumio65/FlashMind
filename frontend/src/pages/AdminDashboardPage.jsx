...
import { Users, BookOpen, Activity, Flag } from 'lucide-react'
          ...
          <>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              {[
                ...
                { icon: BookOpen, label: 'Total Decks',    value: stats.totalDecks,    color: 'text-purple-500' },
                { icon: Activity, label: 'Study Sessions', value: stats.totalSessions, color: 'text-green-500'  },
                { icon: Flag,     label: 'Flagged Decks',  value: stats.flaggedDecks,  color: 'text-red-500'    },
