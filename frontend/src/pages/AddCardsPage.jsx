...
import {
  ArrowLeft, Plus, Trash2, ImagePlus,
  X, BookOpen, AlertTriangle, Save,
} from 'lucide-react'
    ...
    return (
      <PageWrapper>
        <div className="text-center py-20 text-muted-foreground">
          ...
          <p>Deck not found.</p>
          <Button variant="link" asChild><Link to="/dashboard">Go Home</Link></Button>
        </div>
      </PageWrapper>
    )
  }
  ...
  return (
    <PageWrapper className="max-w-5xl">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        >
          <ArrowLeft className="h-4 w-4 mr-1" />Back to Deck
        ...
        <div className="flex items-center gap-3">
          ...
          <Button onClick={handleSave} disabled={validCardCount === 0}>
            ...
            Save {validCardCount > 0 ? `${validCardCount} Card${validCardCount !== 1 ? 's' : ''}` : 'Cards'}
      ...
      <div className="rounded-xl bg-muted/30 border border-border px-5 py-3 mb-6 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Currently has {deck.cards.length} card{deck.cards.length !== 1 ? 's' : ''} · Adding {cards.length} new
          </p>
        </div>
      </div>
              ...
              return (
                ...
                >
                  <span className={cn(
                    ...
                    isActive ? 'bg-primary' : filled ? 'bg-green-500' : 'bg-orange-500'
                  )}>
                    {filled ? '✓' : i + 1}
                  </span>
              ...
              <CardContent className="p-6 flex flex-col gap-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="font-semibold text-foreground">Card {activeCard + 1}</span>
                    {(!currentCard.front.trim() || !currentCard.back.trim()) && (
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs text-muted-foreground font-medium px-2">flip</span>
                  <div className="flex-1 h-px bg-border" />
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-[10px] text-muted-foreground">
                    Press <kbd className="px-1.5 py-0.5 bg-muted rounded">Tab</kbd> to save and add next card
                  </p>
                  <ImageUploadButton
          ...
          <div className="bg-orange-500/10 border-b border-orange-500/20 px-6 py-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-orange-500/70 mt-0.5">Fill in all cards before saving</p>
              </div>
            </div>
          </div>
          <div className="px-6 py-5">
      ...
      <Dialog open={showLeaveWarning} onOpenChange={setShowLeaveWarning}>
        <DialogContent className="max-w-sm p-0 overflow-hidden">
          <div className="bg-destructive/10 border-b border-destructive/20 px-6 py-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-destructive/70 mt-0.5">Your unsaved cards will be lost</p>
              </div>
            </div>
          </div>
          <div className="px-6 py-5">
          ...
          <div className="px-6 py-4 border-t border-border flex justify-end gap-2 bg-muted/20">
            ...
            <Button variant="destructive" onClick={() => navigate(`/decks/${id}`)}>
